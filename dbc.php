...
define ("DB_HOST", "int.instance26727.db.xeround.com:16904"); // set database host
define ("DB_USER", "sakshi"); // set database user
define ("DB_PASS","sakshi"); // set database password
define ("DB_NAME","course_alloc"); // set database name
